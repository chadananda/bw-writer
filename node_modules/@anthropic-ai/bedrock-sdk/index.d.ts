...
import { type RequestInit } from "./_shims/index.js";
...
export declare class AnthropicBedrock extends Core.APIClient {
    ...
    static AnthropicBedrock: typeof AnthropicBedrock;
    static HUMAN_PROMPT: string;
    static AI_PROMPT: string;
    static AnthropicBedrockError: typeof Errors.AnthropicBedrockError;
