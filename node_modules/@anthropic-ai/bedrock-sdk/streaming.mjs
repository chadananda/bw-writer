...
import { AnthropicBedrockError } from "./error.mjs";
...
class LineDecoder {
    ...
    decodeText(bytes) {
        ...
        if (typeof Buffer !== 'undefined') {
            ...
            throw new AnthropicBedrockError(`Unexpected: received non-Uint8Array (${bytes.constructor.name}) stream chunk in an environment with a global "Buffer" defined, which this library assumes to be Node. Please report this error.`);
        }
        // Browser
        if (typeof TextDecoder !== 'undefined') {
            ...
            throw new AnthropicBedrockError(`Unexpected: received non-Uint8Array/ArrayBuffer (${bytes.constructor.name}) in a web platform. Please report this error.`);
        }
        throw new AnthropicBedrockError(`Unexpected: neither Buffer nor TextDecoder are available as globals. Please report this error.`);
    }
    flush() {
