...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import '@anthropic-ai/bedrock-sdk/shims/${shims.kind}'\` before importing anything else from @anthropic-ai/bedrock-sdk`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import '@anthropic-ai/bedrock-sdk/shims/${shims.kind}'\` after \`import '@anthropic-ai/bedrock-sdk/shims/${exports.kind}'\``);
    }
